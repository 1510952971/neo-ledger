...
TransactionItem offlineEntryTransaction(
  ...
  return TransactionItem(
    ...
    originalAmountCents: entry.originalAmountCents,
    originalCurrency: entry.originalCurrency,
    exchangeRateMicros: entry.exchangeRateMicros,
    recognitionText: entry.recognitionText,
    recognitionCompleteness: entry.recognitionCompleteness,
    recognitionCorrections: entry.recognitionCorrections,
